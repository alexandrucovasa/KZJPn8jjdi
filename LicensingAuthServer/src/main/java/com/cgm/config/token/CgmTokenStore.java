...
public class CgmTokenStore extends JdbcTokenStore {
    ...
    public OAuth2Authentication readAuthentication(OAuth2AccessToken oAuth2AccessToken) {
        System.out.println("readAuthentication(OAuth2AccessToken oAuth2AccessToken)");
        return super.readAuthentication(oAuth2AccessToken);
    }

    @Override
    public OAuth2Authentication readAuthentication(String s) {
        System.out.println("readAuthentication(String s)");
        return super.readAuthentication(s);
    }

    @Override
    public void storeAccessToken(OAuth2AccessToken oAuth2AccessToken, OAuth2Authentication oAuth2Authentication) {
        System.out.println("storeAccessToken(OAuth2AccessToken oAuth2AccessToken, OAuth2Authentication oAuth2Authentication)");
        super.storeAccessToken(oAuth2AccessToken, oAuth2Authentication);
    }

    @Override
    public OAuth2AccessToken readAccessToken(String s) {
        System.out.println("readAccessToken(String s)");
        return super.readAccessToken(s);
    }

    @Override
    public void removeAccessToken(OAuth2AccessToken oAuth2AccessToken) {
        System.out.println("removeAccessToken(OAuth2AccessToken oAuth2AccessToken)");
        super.removeAccessToken(oAuth2AccessToken);
    }

    @Override
    public void storeRefreshToken(OAuth2RefreshToken oAuth2RefreshToken, OAuth2Authentication oAuth2Authentication) {
        System.out.println("storeRefreshToken(OAuth2RefreshToken oAuth2RefreshToken, OAuth2Authentication oAuth2Authentication)");
        super.storeRefreshToken(oAuth2RefreshToken, oAuth2Authentication);
    }

    @Override
    public OAuth2RefreshToken readRefreshToken(String s) {
        System.out.println("readRefreshToken(String s)");
        return super.readRefreshToken(s);
    }

    @Override
    public OAuth2Authentication readAuthenticationForRefreshToken(OAuth2RefreshToken oAuth2RefreshToken) {
        System.out.println("readAuthenticationForRefreshToken(OAuth2RefreshToken oAuth2RefreshToken)");
        return super.readAuthenticationForRefreshToken(oAuth2RefreshToken);
    }

    @Override
    public void removeRefreshToken(OAuth2RefreshToken oAuth2RefreshToken) {
        System.out.println("removeRefreshToken(OAuth2RefreshToken oAuth2RefreshToken)");
        super.removeRefreshToken(oAuth2RefreshToken);
    }

    @Override
    public void removeAccessTokenUsingRefreshToken(OAuth2RefreshToken oAuth2RefreshToken) {
        System.out.println("removeAccessTokenUsingRefreshToken(OAuth2RefreshToken oAuth2RefreshToken)");
        super.removeAccessTokenUsingRefreshToken(oAuth2RefreshToken);
    }

    @Override
    public OAuth2AccessToken getAccessToken(OAuth2Authentication oAuth2Authentication) {
        System.out.println("getAccessToken(OAuth2Authentication oAuth2Authentication)");
    ...
    public Collection<OAuth2AccessToken> findTokensByClientIdAndUserName(String s, String s1) {
        System.out.println("findTokensByClientIdAndUserName(String s, String s1)");
        return super.findTokensByClientIdAndUserName(s, s1);
    }

    @Override
    public Collection<OAuth2AccessToken> findTokensByClientId(String s) {
        System.out.println("findTokensByClientId(String s)");
