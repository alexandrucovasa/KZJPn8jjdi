...
public class OAuth2AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(final ClientDetailsServiceConfigurer clients) throws Exception {
        clients
                .inMemory().withClient("sampleClientId")
                .authorizedGrantTypes("implicit")
                .scopes("read", "write", "authenticated", "admin").autoApprove(false).accessTokenValiditySeconds(3600).autoApprove(true)

                .and()
                .withClient("sampleClientId2")
                .authorizedGrantTypes("implicit")
                .scopes("read").autoApprove(false).accessTokenValiditySeconds(3600)
